...
function PhonePopup() {
  ...
  return (
    <div className={styles.phonePopup} role="region" aria-label="Momen phone number">
  ...
  return (
    ...
    >
      <p className={styles.recommendationHelper}>
        Your recommendation will be sent directly to Momen.
      </p>
...
export default function AskBot() {
  ...
  return (
    <div className={styles.root} ref={rootRef}>
                ...
                {recommendationSuccess ? (
                  <>
                    <p className={styles.recommendationSuccess} role="status">
                      Thank you — your recommendation was sent to Momen.
                    </p>
                    <div className={styles.recommendationFormActions}>
                      <button
                        type="button"
          ...
          <form className={styles.composer} onSubmit={handleSubmit}>
            ...
            <div className={styles.inputRow}>
              <input
                ...
                placeholder="Ask about Momen..."
                value={inputValue}
                onChange={(event) => setInputValue(event.target.value)}
                aria-label="Ask about Momen"
              />
              <button
                type="submit"
      ...
      <div
        className={`${styles.launcherShell}${isOpen ? ` ${styles.launcherShellOpen}` : ""}`}
      >
        <button
          type="button"
